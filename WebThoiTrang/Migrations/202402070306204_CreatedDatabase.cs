namespace WebThoiTrang.Migrations
{
    ...
    public partial class CreatedDatabase : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        ModifierdDate = c.DateTime(nullable: false),
                        ModifierBy = c.String(),
                    })
                .PrimaryKey(t => t.Id);
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Tilte1 = c.String(nullable: false, maxLength: 150),
                        CategoryID = c.Int(nullable: false),
                        Description = c.String(),
                        Detail = c.String(),
                        Image = c.String(),
                        SeoTiltle = c.String(),
                        SeoDescrpition = c.String(),
                        SeoKeywords = c.String(),
                        CreatedBy = c.String(),
                        CreatedDate = c.DateTime(nullable: false),
                        ModifierdDate = c.DateTime(nullable: false),
                ...
                c => new
                    {
                        ...
                        SettingDescrpition = c.String(maxLength: 4000),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.tb_OrderDetail", "ProductID", "dbo.tb_Product1");
            ...
            DropForeignKey("dbo.tb_Post1", "CategoryID", "dbo.tb_Category");
            DropForeignKey("dbo.tb_New1", "CategoryID", "dbo.tb_Category");
